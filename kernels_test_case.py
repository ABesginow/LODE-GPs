...
class TestKernel(unittest.TestCase):
    ...
    def test_deriv_term_extraction(self):
        ...
        left_poly = a
        right_poly = b
        result = prepare_asym_deriv_dict(left_poly, right_poly)
        self.assertType(result[0][0][0], torch.nn.Parameter, "Hyperparameter 1 wasn't initialized properly")
        self.assertType(result[0][0][1], torch.nn.Parameter, "Hyperparameter 2 wasn't initialized properly")
        ...
        self.assertEqual(result[0][1], 3, "Exponent 1 not correctly calculated")
        self.assertEqual(result[0][2], 1, "Exponent 2 not correctly calculated")
        self.assertType(result[1][0][0], torch.nn.Parameter, "Hyperparameter 1 wasn't initialized properly")
